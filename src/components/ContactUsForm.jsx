        ...
        <section className={"flex flex-col gap-6"}>
            <div className={"flex flex-col sm:flex-row gap-6 sm:gap-4"}>
                ...
                <div className={"flex flex-col gap-2 w-full"}>
                    ...
                    <input type={"text"} required autoComplete={"true"} name={"lastName"} aria-describedby={"lastName-instructions"} className={"rounded-lg border border-grey-500 px-6 py-3"}/>
                </div>
            </div>
            ...
            <div className={"flex flex-col gap-2 w-full"}>
                ...
                <input type={"email"} required autoComplete={"true"} name={"email"} aria-describedby={"email-instructions"} className={"rounded-lg border border-grey-500 px-6 py-3"}/>
            </div>
            ...
            <div className={"flex flex-col gap-2"}>
                ...
                <textarea required autoComplete={"true"} name={"message"} aria-describedby={"message-instructions"} rows={3} className={"rounded-lg border border-grey-500 px-6 py-3"}/>
            </div>
        </section>
    );
};
